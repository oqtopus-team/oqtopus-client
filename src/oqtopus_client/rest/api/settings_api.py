...
class SettingsApi:
    ...
    async def get_current_settings(
        ...
        _param = self._get_current_settings_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SettingsGetSettingsResponse",
            '401': None,
    ...
    @validate_call
    async def get_current_settings_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SettingsGetSettingsResponse]:
        """Get current settings
    ...
    @validate_call
    async def get_current_settings_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_current_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
