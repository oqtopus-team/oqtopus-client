...
class UsersApi:
    ...
    @validate_call
    async def delete_current_user_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def delete_current_user_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def update_current_user_with_http_info(
        self,
        users_update_user_request: Optional[UsersUpdateUserRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def update_current_user_without_preload_content(
        self,
        users_update_user_request: Optional[UsersUpdateUserRequest] = None,
        _request_timeout: Union[
            None,
